        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-foreground/80 mb-4">
              Based in the heart of North London, I'm not just a developer; I'm a creator. My passion lies in bringing ideas to life, whether it's for a local startup or a high-end enterprise client.
            </p>
            <p className="text-lg text-foreground/80">
              My entrepreneurial journey with my two digital businesses, <a href="#" className="text-primary hover:underline">boroughly.com</a> and <a href="#" className="text-secondary hover:underline">neighbourhoodwash.com</a>, has given me a unique perspective. I understand the entire product lifecycle, from concept to launch, emphasizing quality, detail, and a user experience that truly resonates.
            </p>
          </div>
